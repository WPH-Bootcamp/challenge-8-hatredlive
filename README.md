...
3. **Submit Link**
   Deploy Link: https://stirring-douhua-9169fd.netlify.app/
   **Format Submission:**

```
Nama: Lee Hwa Dong
Repository: https://github.com/WPH-Bootcamp/challenge-8-hatredlive
Deployment: https://stirring-douhua-9169fd.netlify.app/
